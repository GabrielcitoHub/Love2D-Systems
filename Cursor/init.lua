...
local mobile = require(basePath .. "mobile")
...
---@field newCursor fun(self: CCCModule, id: string|integer|nil, sprite: string|nil, width: number|nil, height: number|nil, rotation: number|nil, active: boolean|nil): CursorData?
---@field update fun(self: CCCModule, dt: number)
---@field draw fun(self: CCCModule)
---@field updateState fun(self: CCCModule, cursor: CursorData, dt: number, index:string|integer|nil?)
---@field idle fun(self: CCCModule, cursor: CursorData, dt: integer)
---@field onPressed fun(self: CCCModule, cursor: CursorData)
---@field hold fun(self: CCCModule, cursor: CursorData, dt: integer)
---@field onReleased fun(self: CCCModule, cursor: CursorData)
---@field touchpressed fun(self: CCCModule, id: integer, x: integer, y: integer, dx: integer, dy: integer, pressure: integer)
---@field touchmoved fun(self: CCCModule, id: integer, x: integer, y: integer, dx: integer, dy: integer, pressure: integer)
---@field touchreleased fun(self: CCCModule, id: integer, x: integer, y: integer, dx: integer, dy: integer, pressure: integer)
---@field keypressed fun(self?: CCCModule, key?: string, scancode?: string ,isrepeat?: boolean)
